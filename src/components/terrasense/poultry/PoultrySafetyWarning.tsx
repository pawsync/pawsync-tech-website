...
const conditions: { label: string; status: "normal" | "warning" | "critical" }[] = [
  { label: "Extreme Heat", status: "normal" },
  { label: "Extreme Cold", status: "normal" },
  { label: "High Humidity", status: "normal" },
  { label: "Abnormal Air Quality", status: "warning" },
  { label: "Smoke / Fire Indicators", status: "normal" },
  { label: "Water Shortage", status: "normal" },
  { label: "Power Failure", status: "normal" },
  { label: "Fan Failure", status: "normal" },
  { label: "Pump Failure", status: "normal" },
  { label: "Feeding Equipment Failure", status: "normal" },
  { label: "Flood / Water Leakage", status: "critical" },
  { label: "Communication Failure", status: "normal" },
];
...
const alertChannels = [
  { icon: Smartphone, label: "Mobile Notification" },
  { icon: MessageSquare, label: "SMS Where Supported" },
  { icon: Mail, label: "Email" },
  { icon: Siren, label: "Local Buzzer" },
  { icon: Radio, label: "Warning Light" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 id="poultry-safety-heading" className="mt-4 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Early Awareness When Conditions Change
          </h2>
          <p className="mt-4 text-lg text-white/60">
            Monitoring systems can help operators identify abnormal
            conditions earlier and respond according to their farm
            procedures.
          </p>
        </div>
        ...
        <div className="mx-auto mt-8 flex max-w-2xl items-start justify-center gap-2.5 rounded-xl border border-white/10 bg-white/5 p-4 text-center">
          ...
          <p className="text-xs leading-relaxed text-white/40">
            Sample status shown for illustration. Monitoring systems can help
            identify abnormal conditions but cannot guarantee prevention of
            disasters, equipment failure, or animal loss.
          </p>
        </div>
      </div>
    </section>
