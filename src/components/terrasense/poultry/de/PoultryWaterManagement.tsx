...
const capabilities = [
  "Wassertank-Füllstand", "Durchflussüberwachung", "Pumpensteuerung", "Ventilsteuerung",
  "Wasserverfügbarkeit", "Leckerkennung", "Alarm bei niedrigem Wasserstand",
  "Automatisches Nachfüllen", "Fernsteuerung der Pumpe", "Wasserverbrauchsverlauf",
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1fr] lg:items-center lg:gap-16">
          ...
          <div className="lg:order-2">
            <Eyebrow>Wassermanagement</Eyebrow>
            <h2 id="poultry-water-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
              Zuverlässige Wasserüberwachung &amp; -steuerung
            </h2>
            <p className="mt-4 text-lg leading-relaxed text-[var(--ts-gray)]">
              Behalten Sie Tanks, Leitungen und Pumpen laufend im Blick —
              mit Alarmen, bevor aus einem Engpass ein Problem wird.
            </p>
