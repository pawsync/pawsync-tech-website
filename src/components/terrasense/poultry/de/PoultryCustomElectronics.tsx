...
const services = [
  "Kundenspezifisches Leiterplattendesign", "Embedded-Firmware", "Sensorintegration", "IoT-Konnektivität",
  "LoRa-Systeme", "Wi-Fi-Systeme", "LTE-Konnektivität", "Hof-Controller",
  "Motor- & Relaissteuerung", "Power Management", "Gateway-Entwicklung",
  "Prototypenentwicklung", "Testing", "Fertigungsvorbereitung",
];

const flow = ["Idee", "Architektur", "Schaltplan", "Leiterplatte", "Firmware", "Prototyp", "Testing", "Produktion"];
  ...
  return (
    <section aria-labelledby="poultry-custom-heading" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <Eyebrow>Individuelles Engineering</Eyebrow>
        <h2 id="poultry-custom-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
          Benötigen Sie ein individuelles Geflügel-Elektronikprodukt?
        </h2>
