...
const applications = [
  "Masthähnchenbetriebe", "Legehennenbetriebe", "Elterntierbetriebe", "Brütereien",
  "Geflügelställe", "Futtersysteme", "Wassersysteme",
  "Hofausrüstungs-Unternehmen", "Geflügeltechnologie-Unternehmen",
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 id="poultry-applications-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
            Geflügel-Anwendungen
          </h2>
          <p className="mt-4 text-lg text-[var(--ts-gray)]">
            Von Einzelstallbetrieben bis zu Technologieunternehmen der
            Geflügelbranche.
          </p>
        </div>
