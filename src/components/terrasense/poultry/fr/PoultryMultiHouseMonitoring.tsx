...
const houses: { name: string; metric: string; value: string; status: "normal" | "warning" }[] = [
  { name: "Bâtiment 01", metric: "Température", value: "25,2 °C", status: "normal" },
  { name: "Bâtiment 02", metric: "Température", value: "26,1 °C", status: "normal" },
  { name: "Bâtiment 03", metric: "Température", value: "29,8 °C", status: "warning" },
  { name: "Bâtiment 04", metric: "Niveau d'eau", value: "21 %", status: "warning" },
];

const mapNodes = [
  { top: "22%", left: "18%", label: "Bâtiment 01" },
  { top: "22%", left: "50%", label: "Bâtiment 02" },
  { top: "22%", left: "82%", label: "Bâtiment 03", warn: true },
  { top: "70%", left: "34%", label: "Bâtiment 04", warn: true },
  { top: "70%", left: "68%", label: "Passerelle" },
];
    ...
    <section aria-labelledby="poultry-multihouse-heading" className="bg-[var(--ts-dark-green)]/5 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <Eyebrow>Surveillance multi-bâtiments</Eyebrow>
          <h2 id="poultry-multihouse-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
            Un seul tableau de bord. Plusieurs bâtiments avicoles.
          </h2>
          <p className="mt-4 text-lg text-[var(--ts-gray)]">
            S&apos;adapte d&apos;un seul bâtiment à plusieurs bâtiments,
            plusieurs exploitations et de nombreux capteurs et passerelles.
          </p>
        </div>
            ...
            {houses.map((house) => (
              <div key={house.name} className="rounded-2xl border border-[var(--ts-navy)]/8 bg-white p-4 shadow-[0_1px_2px_rgba(14,27,38,0.04)]">
                ...
                <span className={`mt-2 inline-flex items-center gap-1.5 rounded-full border px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide ${statusStyles[house.status]}`}>
                  ...
                  {house.status === "normal" ? "Normal" : "Avertissement"}
                </span>
              </div>
            ))}
          </div>
