...
const capabilities = [
  "Niveau du réservoir d'eau", "Suivi du débit", "Contrôle des pompes", "Contrôle des vannes",
  "Disponibilité de l'eau", "Détection de fuites", "Alertes de niveau d'eau bas",
  "Remplissage automatique du réservoir", "Contrôle à distance des pompes", "Historique de consommation d'eau",
];

const flow = [
  { icon: Droplets, label: "Réservoir" },
  { icon: Gauge, label: "Capteur" },
  { icon: Cpu, label: "Contrôleur" },
  { icon: Waves, label: "Pompe / vanne" },
  { icon: MonitorSmartphone, label: "Tableau de bord IoT" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1fr] lg:items-center lg:gap-16">
          ...
          <div className="lg:order-2">
            <Eyebrow>Gestion de l&apos;eau</Eyebrow>
            <h2 id="poultry-water-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
              Surveillance et contrôle fiables de l&apos;eau
            </h2>
            <p className="mt-4 text-lg leading-relaxed text-[var(--ts-gray)]">
              Gardez les réservoirs, canalisations et pompes sous surveillance
              continue — avec des alertes avant qu&apos;une pénurie ne devienne
              un problème.
            </p>
