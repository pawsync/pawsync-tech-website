...
const houses: { name: string; metric: string; value: string; status: "normal" | "warning" }[] = [
  { name: "House 01", metric: "Temperature", value: "25.2°C", status: "normal" },
  { name: "House 02", metric: "Temperature", value: "26.1°C", status: "normal" },
  { name: "House 03", metric: "Temperature", value: "29.8°C", status: "warning" },
  { name: "House 04", metric: "Water Level", value: "21%", status: "warning" },
];

const mapNodes = [
  { top: "22%", left: "18%", label: "House 01" },
  { top: "22%", left: "50%", label: "House 02" },
  { top: "22%", left: "82%", label: "House 03", warn: true },
  { top: "70%", left: "34%", label: "House 04", warn: true },
    ...
    <section aria-labelledby="poultry-multihouse-heading" className="bg-[var(--ts-dark-green)]/5 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <Eyebrow>Multi-House Monitoring</Eyebrow>
          <h2 id="poultry-multihouse-heading" className="mt-3 font-[family-name:var(--font-manrope)] text-3xl font-bold tracking-tight text-[var(--ts-navy)] sm:text-4xl">
            One Dashboard. Multiple Poultry Houses.
          </h2>
          <p className="mt-4 text-lg text-[var(--ts-gray)]">
            Scales from a single house to multiple houses, multiple farms,
            and many sensor nodes and gateways.
          </p>
        </div>
