...
const readout = [
  { icon: Thermometer, label: "Temperature", value: "25.4°C" },
  { icon: Droplets, label: "Humidity", value: "61%" },
  { icon: Cloud, label: "Air Quality", value: "Good" },
  { icon: Droplets, label: "Water Level", value: "82%" },
  { icon: UtensilsCrossed, label: "Feed Level", value: "68%" },
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-14 pt-10 sm:px-6 sm:pt-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-10 lg:px-8 lg:pb-16 lg:pt-16">
        <div>
          ...
          <h1 className="mt-5 font-[family-name:var(--font-manrope)] text-4xl font-extrabold leading-[1.12] tracking-tight text-white sm:text-5xl sm:leading-[1.08] lg:text-[3.4rem]">
            Intelligent Monitoring &amp; Automation for Modern Poultry Farms
          </h1>

          <p className="mt-5 max-w-[600px] text-lg leading-relaxed text-white/70">
            Custom IoT devices, environmental monitoring, feeding and
            watering controls, climate automation, safety alerts, and
            connected electronics designed for modern poultry operations.
          </p>
