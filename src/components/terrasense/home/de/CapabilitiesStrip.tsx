const groups: { label: string; items: string[] }[] = [
  {
    label: "Elektronik",
    items: ["Embedded Systems", "Leiterplattenentwicklung", "Power Management", "Sensorintegration"],
  },
  {
    label: "Konnektivität",
  ...
  },
  {
    ...
    items: ["Prototypenentwicklung", "Firmware", "Testing", "Produktionsvorbereitung"],
  },
];
