...
const workflow: { icon: LucideIcon; label: string }[] = [
  { icon: Thermometer, label: "Sensoren" },
  { icon: Cpu, label: "Embedded-Controller" },
  { icon: Rss, label: "Funkkommunikation" },
  { icon: Cloud, label: "Cloud / lokales Gateway" },
  { icon: MonitorSmartphone, label: "Dashboard / App" },
  { icon: Bell, label: "Alarme & Automatisierung" },
];
    ...
    <section aria-labelledby="tech-workflow-heading" className="bg-[var(--ts-dark-green)]/5 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            Vom Sensor zum Smartphone
          </h2>
          <p className="mt-4 text-lg text-[var(--ts-gray)]">
            Jedes von uns entwickelte Gerät folgt demselben zuverlässigen Datenpfad.
          </p>
        </div>
