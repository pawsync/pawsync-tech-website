...
const callouts = [
  ...
  { icon: Gauge, label: "Bewegungssensor", top: "52%", left: "14%" },
  { icon: Thermometer, label: "Temp.-Sensor", top: "52%", left: "86%" },
  { icon: Battery, label: "Akku, wiederaufladbar", top: "76%", left: "14%" },
  { icon: Cpu, label: "Stromsparender Mikrocontroller", top: "76%", left: "86%" },
  { icon: ShieldCheck, label: "Wetterfestes Gehäuse", top: "96%", left: "50%" },
];
  ...
  return (
    <section aria-labelledby="engineered-hardware-heading" className="overflow-hidden bg-[var(--ts-navy)] py-16 sm:py-20">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8">
        ...
        {/* Right: copy */}
        <div>
          <Eyebrow tone="dark">Entwickelt für die reale Welt</Eyebrow>
          <h2
