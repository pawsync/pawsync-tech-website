...
const stats = [
  { icon: Users, label: "Total Animals", value: "128" },
  { icon: Wifi, label: "Online", value: "124" },
  { icon: AlertTriangle, label: "Active Alerts", value: "3" },
  { icon: Thermometer, label: "Avg. Temperature", value: "24.8°C" },
  { icon: Droplets, label: "Water Level", value: "78%" },
  { icon: UtensilsCrossed, label: "Feed Level", value: "64%" },
];

const alerts = [
  { title: "Cattle #074 — Outside Zone", tone: "critical" as const },
  { title: "Barn 2 — Temperature High", tone: "warning" as const },
  { title: "Water Tank 1 — Level Below 25%", tone: "warning" as const },
];
    ...
    <section aria-labelledby="live-intelligence-heading" className="relative overflow-hidden bg-[var(--ts-navy)] py-16 sm:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <Eyebrow tone="dark">Real-Time Intelligence</Eyebrow>
          <h2
          ...
          >
            See What&apos;s Happening Across Your Farm
          </h2>
          <p className="mt-4 text-lg text-white/60">
            Example interface demonstrating how connected PawSync hardware
            can surface actionable farm data.
          </p>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.6fr_1fr]">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
            <h3 className="text-sm font-bold uppercase tracking-wide text-white/70">Recent Alerts</h3>
        ...
        <p className="mt-6 text-center text-xs text-white/40">
          Sample figures for demonstration purposes only.
        </p>
      </div>
    </section>
  );
