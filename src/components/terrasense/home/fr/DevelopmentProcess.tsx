...
const steps: { icon: LucideIcon; title: string; description: string }[] = [
  {
    icon: Compass,
    title: "Découverte",
    description: "Comprendre le problème, les animaux, l'environnement de l'exploitation et les exigences du produit.",
  },
  {
    icon: Workflow,
    title: "Architecture système",
    description: "Définir les capteurs, la technologie de communication, l'alimentation, l'électronique et l'architecture logicielle.",
  },
  {
    icon: CircuitBoard,
    title: "Conception électronique",
    description: "Conception du schéma, conception de la carte PCB et sélection des composants.",
  },
  {
    icon: FlaskConical,
    title: "Développement de prototype",
    description: "Construire et valider un prototype fonctionnel.",
  },
  {
    icon: FileCode,
    title: "Micrologiciel & connectivité",
    description: "Développement du logiciel embarqué, de la communication sans fil et des protocoles du dispositif.",
  },
  {
    icon: ClipboardCheck,
    title: "Préparation à la production",
    description: "Préparation des fichiers PCB, de la nomenclature, des fichiers de fabrication, des procédures de test et de la documentation technique.",
  },
];
  ...
  return (
    <section aria-labelledby="development-process-heading" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="mt-14 text-center">
        ...
        >
          Discuter de votre idée de produit
