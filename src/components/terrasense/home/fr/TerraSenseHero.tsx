...
const trustIndicators = ["GPS / GNSS", "LoRa", "Bluetooth", "Wi-Fi", "LTE", "RFID", "Cartes PCB sur mesure"];
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-14 pt-10 sm:px-6 sm:pt-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-10 lg:px-8 lg:pb-16 lg:pt-16">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-sm font-semibold text-[var(--ts-accent)] ring-1 ring-inset ring-white/10">
            ...
            Électronique intelligente pour animaux et fermes
          </span>
          ...
          <h1 className="mt-5 font-[family-name:var(--font-manrope)] text-4xl font-extrabold leading-[1.12] tracking-tight text-white sm:text-5xl sm:leading-[1.08] lg:text-[3.75rem]">
            <span className="sm:block">Électronique intelligente pour </span>
            <span className="sm:block">animaux, exploitations agricoles &amp; </span>
            <span className="sm:block">environnements connectés</span>
          </h1>

          <p className="mt-5 max-w-[600px] text-lg leading-relaxed text-white/70">
            Nous concevons des dispositifs IoT intelligents, des systèmes de
            suivi des animaux, des solutions d&apos;alimentation
            intelligente, des technologies de suivi de la santé, des
            systèmes de clôture virtuelle, des capteurs environnementaux et
            une électronique de contrôle automatisée pour l&apos;exploitation
            agricole.
          </p>
        ...
        <div className="relative">
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl shadow-2xl ring-1 ring-white/10">
            <Image
              ...
              alt="Un veau identifié se tient dans un pâturage vert, représentant un animal équipé d'une technologie de suivi connectée"
              fill
          ...
          <div className="absolute top-3 right-3 w-44 rounded-2xl border border-white/10 bg-[var(--ts-navy)]/95 p-3.5 shadow-xl backdrop-blur sm:-top-5 sm:-right-6 sm:w-52">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-white/80">Capteur de bâtiment 04</span>
