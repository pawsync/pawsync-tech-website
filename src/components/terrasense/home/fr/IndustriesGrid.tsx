...
const industries: { image: string; alt: string; label: string; tagline: string; href?: string }[] = [
  {
    ...
    alt: "Un labrador noir portant un collier rouge",
    label: "Technologie pour animaux de compagnie",
    tagline: "Suivi • Santé • Sécurité",
    href: "/fr/pet-technology",
  },
  {
    image: "https://images.unsplash.com/photo-1573611236714-1fe596de1fd3?auto=format&fit=crop&w=500&q=75",
    alt: "Un veau identifié se tient dans un pâturage vert",
    label: "Élevage de bétail",
    tagline: "Suivi • Santé • Automatisation",
  ...
  },
  {
    ...
    alt: "Une vache laitière Holstein se tient dans un champ",
    label: "Élevage laitier",
    tagline: "Suivi du troupeau • Données de production",
  },
  {
    image: "https://images.unsplash.com/photo-1612170153139-6f881ff067e0?auto=format&fit=crop&w=500&q=75",
    alt: "Une poule dans un élevage avicole",
    label: "Aviculture",
    tagline: "Climat • Alimentation • Eau • Automatisation",
    href: "/fr/poultry-farming",
  },
  {
    image: "https://images.unsplash.com/photo-1599635406076-0f40532a59fc?auto=format&fit=crop&w=500&q=75",
    alt: "Des chevaux dans un pâturage brumeux au lever du soleil",
    label: "Technologie équine",
    tagline: "Localisation • Suivi de l'activité",
  },
  {
    image: "https://images.unsplash.com/photo-1665849325502-92a086699cb5?auto=format&fit=crop&w=500&q=75",
    alt: "Gros plan d'un cerf dans une forêt",
    label: "Suivi de la faune sauvage",
    tagline: "Conservation • Données de déplacement",
  },
  {
    image: "https://images.unsplash.com/photo-1656407410275-e63e689bcd90?auto=format&fit=crop&w=500&q=75",
    alt: "Vue aérienne d'équipements d'agriculture de précision dans un champ",
    label: "Agriculture intelligente",
    tagline: "Capteurs • Automatisation",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-[var(--ts-gray)]">
            Partout où les animaux et l&apos;électronique se rencontrent, nous concevons pour cela.
          </p>
        </div>

        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {industries.map((industry) => {
            const isFeatured = industry.label === "Aviculture";
          ...
          <div className="group relative flex aspect-[3/4] flex-col items-center justify-center gap-3 overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--ts-dark-green)] to-[var(--ts-navy)] p-4 text-center shadow-[0_1px_2px_rgba(14,27,38,0.04)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-12px_rgba(14,27,38,0.28)]">
            ...
            <div>
              <span className="text-sm font-bold uppercase tracking-wide text-white">Start-ups &amp; projets sur mesure</span>
