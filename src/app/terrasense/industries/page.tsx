...
const industries: { icon: LucideIcon; label: string; href?: string }[] = [
  { icon: Dog, label: "Pet Technology Companies", href: "/terrasense/pet-technology" },
  { icon: Tractor, label: "Livestock Farms", href: "/terrasense/livestock-technology" },
  { icon: Milk, label: "Dairy Farms" },
  { icon: Bird, label: "Poultry Farms", href: "/terrasense/poultry-farming" },
